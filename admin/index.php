...
?>
 <div style="width:960px; margin-left:auto; margin-right:auto;">
  <div><a href="/admin/index.php?t=item">宝贝管理</a> 
  <a href="/admin/index.php?t=class">宝贝分类管理</a> 
  <a href="/admin/index.php?t=art">文章管理</a>
  <a href="/admin/index.php?t=tag">文章分类管理</a> </div>
<br />
<?php 
...
<!-- -->
 ...
 <!--  <input type="text" name="artpr_id" id="artpr_id" value="<?=$data['artpr_id']?>" /> -->
    <div>
      <table width="100%" border="1">
        <tr>
          <td width="26%">id(<b style="color: red">不用填</b>):</td>
...
?>
      <tr align="center">
        <td><?=$row['artpr_id']?></td>
        <td><?=$row['name']?></td>     
        <td><a href="/admin/index.php?t=tag&act=edit&id=<?=$row['artpr_id']?>">修改</a> <a href="/admin/index.php?t=tag&act=del&id=<?=$row['artpr_id']?>">删除</a></td>
      </tr>
<?php 
	}
?>
