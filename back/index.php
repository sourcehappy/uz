...
<div  style="width:1020px;
  ...
  <div id="vgogoleft">
    <!--logo-->
    <div id="vgogologo"><img src="/assets/images/logo.jpg"  /></div>
    <!--/logo-->
    <!--左侧标签-->
<?php 
    ...
    <div id="vgogoindexturn">
      <div style="position: relative; left:40px; top:53px;width:350px">
      	<div class="banner">
	        ...
	        <a href="http://doufuwang.uz.taobao.com/#" class="banner_info"></a> 
	        <ul class="list"></ul>
...
?>
      	<a target="_blank" class="pic" href="/item.php?id=<?=$row["prod_id"]?>">
